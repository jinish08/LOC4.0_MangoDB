    ...
    <div>
      ...
      <Container style={{ marginLeft: 320, marginTop: 150 }}>
        <HStack p="20px" w="1000px" spacing={30} style={{ marginBottom: 50 }}>
          <IndividExe exername="Running" desc="Running is important for any athlete" imgURL="http://localhost:3000/assets/running.gif"/>
        ...
        <HStack p="20px" w="1000px" spacing={30} style={{ marginTop: 20 }}>
          <IndividExe exername="PushUps" desc="Bowling is important for any cricketer" imgURL="http://localhost:3000/assets/pushups.gif"/>
